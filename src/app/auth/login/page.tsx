...
export default function LoginPage() {
  ...
  const handleCredentialSignIn = useCallback(async({email,password}:{
    email:string,
    password:string;
  })=>{
      ...
      <div className="flex items-center justify-center py-12">
        <div className="mx-auto grid w-[350px] gap-6">
          ...
          <form onSubmit={form.onSubmit((values)=>{
            ...
            <TextInput type="email" withAsterisk {...form.getInputProps('email')} label="Email" placeholder="m@example.com"/>
            <TextInput label="Password"  placeholder="**** *** ***" type="password" required {...form.getInputProps('password')} />
