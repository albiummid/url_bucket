                        ...
                        <div className=" space-y-2 w-full ">
                            <div className="md:mb-10 ">
                                <span className="text-lg  md:text-3xl  font-semibold  sm:text-left">
                                    Simple and fast <br />{" "}
                                    <span className=" text-red-500 text-2xl md:text-5xl ">
                                        <Typewriter
                                            cursor
                                            cursorStyle={"_"}
                                            words={[
                            ...
                            <p className="text-xs sm:text-base ">
                                ...
                                Instagram, Facebook, YouTube, Twitter, Linked
                                In, WhatsApp, TikTok, blogs and sites. Just
                                paste the long URL and click the Shorten URL
                                button. On the next page, copy the shortened URL
                                and share it on sites, chat and emails. After
                                shortening the URL, check how many clicks it
                                received.
                            </p>
      ...
      <Input placeholder='Type or Paste your link here...' style={{outline:'none'}} className='border border-black'  />
                ...
                <div className="grid grid-cols-2 md:gap-5 gap-2 md:mt-10 mt-5  md:grid-cols-3 lg:grid-cols-3 justify-center">
                    <FeatureCard
                        ...
                        label="Blazing fast"
                        description="url-bucket is easy and fast, enter the long link to get your shortened link"
                    />
                    <FeatureCard
                        icon={require("@/assets/icons/link-building.png")}
                        label="Shortened"
                        description="Use any link, no matter what size, ShortURL always shortens"
                    />

                    <FeatureCard
                        icon={require("@/assets/icons/secure.png")}
                    ...
                    />
                    <FeatureCard
                        icon={require("@/assets/icons/guarantee.png")}
                        label="Analytics"
...
const FeatureCard = ({
    ...
    return (
        <div className="cursor-cell flex flex-col items-center  border-2 p-2 rounded-lg border-slate-300 duration-300 hover:bg-rose-200 hover:border-rose-400">
            <Image
                className=" h-10 w-10 md:h-14 md:w-14"
                src={icon}
                alt="hello"
            />
            <p className="text-center font-semibold text-xs md:text-base  mb-2">
                {label}
            </p>
